...
If you use Numerov.jl in your research, please cite this repository — citation
metadata is provided in [`CITATION.cff`](CITATION.cff) (GitHub's "Cite this
repository" button generates BibTeX from it).
