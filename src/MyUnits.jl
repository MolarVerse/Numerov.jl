...
# Named m_e (not me) to avoid clashing with Unitful's own `me` constant,
# which triggers a "found in multiple registered unit modules" warning.
@unit m_e       "m_e"     electronMass   5.48579909065e-4*u"u" true
